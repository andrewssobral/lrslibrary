% TTD | RMAMR | Robust Motion-Assisted Matrix Restoration (Ye et al. 2015)
% process_video('TTD', 'RMAMR', 'dataset/demo.avi', 'output/demo_MAMR.avi');
%{
clc;
lrs_load_conf;
...
lambda = 10;
[L,S,E,iter1] = core_RMAMR(M,lambda,I,J);
